    ...
    rlPushMatrix();
      ...
      rlPushMatrix();
        ...
        DrawTextureEx(texture_group->jacket_diff,
                      ...
                      from_hex(chart_settings->difficulty_color));
        BeginShaderMode(font_services->sdf_shader);
          DrawTextEx(font_services->saira_medium, chart_settings->difficulty, (Vector2) { 0.0f, JACKET_HUD_SIZE }, 50.0f, 0, WHITE);
        EndShaderMode();
      rlPopMatrix();
    rlPopMatrix();
      ...
      rlPushMatrix();
        ...
        BeginShaderMode(font_services->sdf_shader);
          ...
          rlPushMatrix();
            ...
            DrawTextEx(font_services->saira_regular, chart_settings->title, Vector2Zero(), 70.0f, 0, WHITE);
            DrawTextEx(font_services->saira_regular, chart_settings->composer, (Vector2){ 0.0f, 75.0f }, 46.0f, 0, WHITE);
          rlPopMatrix();
        EndShaderMode();
      rlPopMatrix();
  rlPopMatrix();
